...
// Ganti baris. Sengaja dibuat jadi fungsi, bukan ditulis #13#10 langsung:
// Inno Setup memperlakukan baris yang diawali tanda pagar sebagai perintah
// kompiler (seperti #define di atas), jadi #13#10 yang kebetulan jatuh di
// awal baris akan membuat kompilasi gagal. Dengan fungsi ini hal itu tidak
// mungkin terjadi lagi, sekalipun nanti teksnya dirapikan ulang.
function NL(): String;
begin
